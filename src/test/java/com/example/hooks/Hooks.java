...
public class Hooks {
            ...
            for (String plantName : testPlantNames) {
                ...
                try {
                    ...
                    By deleteBtnBy = By.xpath(
                            "//tr[td[contains(text(),'" + plantName
                                    + "')]]//button[contains(@class,'btn-danger') or contains(@title,'Delete')]");
    ...
    // String deleteXpath = "//td[contains(text(), '" + plantName +
    // "')]//following::button[contains(@class, 'btn-danger') or contains(text(),
    // 'Delete')]";
    ...
    // String actionXpath = "//td[contains(text(), '" + plantName +
    // "')]//following::button[contains(@class, 'dropdown') or contains(@class,
    // 'menu')]";
    ...
    // By.xpath("//button[contains(text(), 'Confirm') or contains(text(), 'Yes') or
    // contains(text(), 'OK') or contains(text(), 'Delete')]")));
    // confirmBtn.click();
    ...
    // }
    // } catch (Exception e) {
    // System.out.println("Could not delete plant: " + plantName + " - " +
    // e.getMessage());
    // }
    // }
    // } catch (Exception e) {
