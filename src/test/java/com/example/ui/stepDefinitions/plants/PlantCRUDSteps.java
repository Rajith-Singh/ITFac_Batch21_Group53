...
public class PlantCRUDSteps {
    ...
    public void adminClicksOnEditIconForPlant(String plantName) {
        com.example.ui.pages.plants.PlantListPageP plantListPg = new com.example.ui.pages.plants.PlantListPageP(driver);
    ...
    public void newlyAddedPlantShouldBeDisplayedInTheList(String plantName) {
        com.example.ui.pages.plants.PlantListPageP plantListPage = new com.example.ui.pages.plants.PlantListPageP(driver);
