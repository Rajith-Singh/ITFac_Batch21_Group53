...
echo "Test Cases: TC_API_PLANTS_USER_06, TC_API_PLANTS_USER_07, TC_API_PLANTS_USER_08, TC_API_PLANTS_USER_09, TC_API_PLANTS_USER_10, TC_API_PLANTS_USER_11, TC_API_PLANTS_USER_12"
echo "=========================================="
